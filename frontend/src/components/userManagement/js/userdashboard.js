$(document).ready(function () {
    ...
    function renderAuditLogs() {
  return `<h2>Noti</h2><div id="root"></div><script src="notification.js"></script>`;
}
...
$(document).ready(function () {
    // Registration link click handler
    $('#aregistration').click(function (e) {
        e.preventDefault();
        window.location.href = 'create_user.html'; // Redirect to user registration page
    });

    // Reset Password link click handler
    $('#aresetpassword').click(function (e) {
        e.preventDefault();
